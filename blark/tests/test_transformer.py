...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("integer_literal", "UDINT#2#010", tf.Integer(value="010", base=2, type="UDINT")),
        pytest.param("integer_literal", "UDINT#2#1001_0011", tf.Integer(value="1001_0011", base=2, type="UDINT")),
        pytest.param("integer_literal", "DINT#16#C0FFEE", tf.Integer(value="C0FFEE", base=16, type="DINT")),
        ...
        pytest.param("bit_string_literal", "WORD#2#0101", tf.BitString(type="WORD", value="0101", base=2)),
        pytest.param("bit_string_literal", "WORD#8#777", tf.BitString(type="WORD", value="777", base=8)),
        pytest.param("bit_string_literal", "word#16#FEEE", tf.BitString(type="word", value="FEEE", base=16)),
        ...
        pytest.param("duration", "T#1D1H1M1S1MS", tf.Duration(days="1", hours="1", minutes="1", seconds="1", milliseconds="1")),
        pytest.param("duration", "TIME#1H1M1S1MS", tf.Duration(hours="1", minutes="1", seconds="1", milliseconds="1")),
        pytest.param("time_of_day", "TIME_OF_DAY#1:1:1.2", tf.TimeOfDay(hour="1", minute="1", second="1.2")),
